<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Derive.aspx.cs" Inherits="finalHomeWork.pageList.Derive" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>浩源书屋-衍生同人</title>
...
<body>
    ...
    <div class="header w">
        ...
        <!-- box start -->
    <div class="box w">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BookWebConnectionString %>" SelectCommand="SELECT * FROM [Derive_View]"></asp:SqlDataSource>
        <!-- 此地方一定要清除浮动，务必务必务必 -->
