<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Game.aspx.cs" Inherits="finalHomeWork.pageList.Game" %>
...
<body>
    ...
    <div class="header w">
        ...
        <!-- box start -->
    <div class="box w">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BookWebConnectionString %>" SelectCommand="SELECT * FROM [Game_View]"></asp:SqlDataSource>
        <!-- 此地方一定要清除浮动，务必务必务必 -->
