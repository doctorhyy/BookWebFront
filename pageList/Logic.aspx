<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Logic.aspx.cs" Inherits="finalHomeWork.pageList.Logic" %>
...
<body>
    ...
    <div class="header w">
        ...
        <!-- box start -->
    <div class="box w">
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BookWebConnectionString %>" SelectCommand="SELECT * FROM [Logic_View]"></asp:SqlDataSource>
        <!-- 此地方一定要清除浮动，务必务必务必 -->
